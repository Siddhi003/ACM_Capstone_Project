...
inp, re = load(PATH+'train/100_AB.jpg')
...
for i, (inp, tar) in enumerate(test_dataset):
  generate_images(generator, inp, tar, base_path='results/final', epoch=i)
# input_image = tf.io.read_file("test.jpg")
# input_image = tf.image.decode_jpeg(input_image)
# real_image = tf.io.read_file("test_real.jpg")
# real_image = tf.image.decode_jpeg(real_image)
# input_image = tf.cast(input_image, tf.float32)
# real_image = tf.cast(real_image, tf.float32)
# input_image, real_image = resize(input_image, real_image, IMG_HEIGHT, IMG_WIDTH)
# input_image, real_image = normalize(input_image, real_image)
# generate_images(generator, input_image, real_image, base_path="results/final", epoch=250)
